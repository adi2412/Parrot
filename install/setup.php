...
if (!file_exists(PATH . 'config' . EXT)) {
    ...
    $query = "CREATE TABLE " . $DBprefix . "Discussion(title TEXT(20000), content TEXT(20000), author TEXT(20000), time TEXT(20000), category TEXT(20000) NULL, timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP , sticky text(20000), locked text(20000))";
    ...
    $date = date('jS F, Y');
    mysqli_query($DB, "INSERT INTO " . $DBprefix . "Discussion(title, content, author, time, category, timestamp, sticky, locked) VALUES('Hello World', 'This is your first discussion.', '$username', '$date', 'Uncategorized', NULL, 'false', 'false')");
